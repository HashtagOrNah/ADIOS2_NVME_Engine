...
void emulate_arith3i(int code, struct reg_type *dest, struct reg_type *src1, IMM_TYPE imm)
{
    switch(code) {
	  ...
	  case dill_jmp_addp:  dest->u.p.p = (char*) src1->u.p.p + (IMM_TYPE) imm; break;
	  ...
	  case dill_jmp_subp:  dest->u.p.p = (char*) src1->u.p.p - (IMM_TYPE) imm; break;
...
int emulate_branchi(int code, struct reg_type *src1, IMM_TYPE imm)
{
    switch(code) {
	  ...
	  case dill_jmp_bequ:  return ( src1->u.u.u) ==  imm;
	  case dill_jmp_bequl:  return ( src1->u.ul.ul) ==  imm;
	  case dill_jmp_beql:  return ( src1->u.l.l) ==  imm;
	  case dill_jmp_beqp:  return ((char*) src1->u.p.p) == (char*) imm;
	  ...
	  case dill_jmp_bgeu:  return ( src1->u.u.u) >=  imm;
	  case dill_jmp_bgeul:  return ( src1->u.ul.ul) >=  imm;
	  case dill_jmp_bgel:  return ( src1->u.l.l) >=  imm;
	  case dill_jmp_bgep:  return ((char*) src1->u.p.p) >= (char*) imm;
	  ...
	  case dill_jmp_bgtu:  return ( src1->u.u.u) >  imm;
	  case dill_jmp_bgtul:  return ( src1->u.ul.ul) >  imm;
	  case dill_jmp_bgtl:  return ( src1->u.l.l) >  imm;
	  case dill_jmp_bgtp:  return ((char*) src1->u.p.p) > (char*) imm;
	  ...
	  case dill_jmp_bleu:  return ( src1->u.u.u) <=  imm;
	  case dill_jmp_bleul:  return ( src1->u.ul.ul) <=  imm;
	  case dill_jmp_blel:  return ( src1->u.l.l) <=  imm;
	  case dill_jmp_blep:  return ((char*) src1->u.p.p) <= (char*) imm;
	  ...
	  case dill_jmp_bltu:  return ( src1->u.u.u) <  imm;
	  case dill_jmp_bltul:  return ( src1->u.ul.ul) <  imm;
	  case dill_jmp_bltl:  return ( src1->u.l.l) <  imm;
	  case dill_jmp_bltp:  return ((char*) src1->u.p.p) < (char*) imm;
	  ...
	  case dill_jmp_bneu:  return ( src1->u.u.u) !=  imm;
	  case dill_jmp_bneul:  return ( src1->u.ul.ul) !=  imm;
	  case dill_jmp_bnel:  return ( src1->u.l.l) !=  imm;
	  case dill_jmp_bnep:  return ((char*) src1->u.p.p) != (char*) imm;
    }return 0;
}
...
void emulate_convert(int code, struct reg_type *dest, struct reg_type *src)
{
	...
	case CONV(DILL_UL, DILL_C): dest->u.c.c = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_UC): dest->u.uc.uc = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_S): dest->u.s.s = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_US): dest->u.us.us = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_I): dest->u.i.i = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_U): dest->u.u.u = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_L): dest->u.l.l = (UIMM_TYPE)src->u.ul.ul; break;
	...
	case CONV(DILL_UL, DILL_F): dest->u.f.f = (UIMM_TYPE)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_D): dest->u.d.d = (UIMM_TYPE)src->u.ul.ul; break;
